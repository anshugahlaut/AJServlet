...
public class FormCompsServlet extends HttpServlet {
	...
	//get PrintWriter
		...
		String hobies[]=req.getParameterValues("hb");
		    if(hobies==null)
		    	hobies=new String[] {"no languages are selected"};
		...
		if(gender.equalsIgnoreCase("M")) {
			if(age<5)
				...
				pw.println("<h1 style='color:blue;text-align:center'>Mr::"+name+"u r a teenaged boy </h1");
			else if(age<35)
				pw.println("<h1 style='color:blue;text-align:center'>Mr::"+name+"  u r a young boy </h1");
			else if(age<50)
			...
			if(age<5)
				...
				if(ms.equalsIgnoreCase("married"))
					...
					pw.println("<h1 style='color:blue;text-align:center'>Mrs::"+name+"u r a teenage girl </h1");
			}
			else if(age<35) {
				if(ms.equalsIgnoreCase("married"))
					pw.println("<h1 style='color:blue;text-align:center'>Mrs::"+name+"u r a young married girl </h1");
				else
					pw.println("<h1 style='color:blue;text-align:center'>Mrs::"+name+"u r a young girl </h1");
			}
			else if(age<50) {
				if(ms.equalsIgnoreCase("married"))
		...
		pw.println("<br><b> Gender :: <br>"+gender);
